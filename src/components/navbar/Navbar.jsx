...
//                   {user?.user?.email === "rohitkanaujiya4006@gmail.com" ? (
//                     <div className="flow-root">
//                       <Link
//                         to={"/dashboard"}
//                         className="-m-2 block p-2 font-medium text-gray-900"
...
//                         src="https://thumbs.dreamstime.com/b/mz-m-z-letter-logo-design-initial-linked-circle-upercase-monogram-red-blue-193502425.jpg"
//                         alt="Rohit kanaujiya"
//                       />{" "}
//                     </Link>
//                   </div>
...
//         <p
//           className="flex h-10 items-center justify-center bg-cyan-500 px-4 text-sm font-medium text-white sm:px-6 lg:px-8"
//           style={{
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "rohitkanaujiya4006@gmail.com" ? <div className="flow-root">
          ...
          <div className="">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Med-Zippy</h1>
                  </div>
                </Link>
              </div>
